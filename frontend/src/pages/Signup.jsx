...
export default function Signup() {
  ...
  return (
    <form onSubmit={submit} className="max-w-sm mx-auto bg-white p-6 rounded-lg border mt-8">
      ...
      <input className="border p-2 w-full rounded mb-3" placeholder="Jane Doe" value={name} onChange={(e) => setName(e.target.value)} />
      ...
      <button className="px-4 py-2 bg-black text-white rounded w-full">Sign up</button>
    </form>
  );
}

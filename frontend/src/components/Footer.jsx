        ...
        <footer className="bg-gray-900 text-gray-300 mt-20">
            <div className="max-w-7xl mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    {/* Company Info */}
                    <div>
                        <h3 className="text-white text-lg font-bold mb-4">ShopEase</h3>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link to="/products?category=Home" className="hover:text-primary-400 transition-colors">Home & Living</Link></li>
                            <li><Link to="/products?category=Fitness" className="hover:text-primary-400 transition-colors">Fitness</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="mt-6">
                            ...
                            <p className="text-xs text-gray-400">support@shopease.com</p>
                            <p className="text-xs text-gray-400">1-800-SHOPEASE</p>
                        </div>
                    </div>
                </div>
